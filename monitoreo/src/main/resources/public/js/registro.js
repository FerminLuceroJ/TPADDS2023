const INPUTS_IDS = ["email", "contraseña", "usuario", "nombre", "apellido", "dni", "telefono"];
...
document.addEventListener("DOMContentLoaded", (event) => {
    ...
    */
    document.getElementById("btn-submit").addEventListener("click", mostrarEnConsolaInputs);
    document.getElementById("btn-submit").addEventListener("click", validarInputs);
